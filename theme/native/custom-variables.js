...
export const background = {
  primary: darkMode
    ? backgroundDefaults.primaryDark
    : backgroundDefaults.primaryLight,
  secondary: darkMode
    ? backgroundDefaults.secondaryDark
    : backgroundDefaults.secondaryLight,
...
export const font = {
  ...
  colorTitle: darkMode
    ? fontDefaults.colorTitleLight
    : fontDefaults.colorTitleDark,
  colorParagraph: darkMode
    ? fontDefaults.colorParagraphLight
    : fontDefaults.colorParagraphDark,
  colorDisabled: darkMode
    ? fontDefaults.colorDisabledLight
    : fontDefaults.colorDisabledDark,
  weightLight: '100',
  weightNormal: 'normal',
  weightSemiBold: '600',
  weightBold: 'bold',
